...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?= url_to('userAddHazard') ?>" class="btn btn-primary btn-sm">Add Hazard</a>
        </div>
        <!-- /.card-header -->
                    ...
                    foreach ($datax as $data) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= url_to('userEditHazard', $data->id); ?>" class="btn btn-warning">Edit</a>
                                <a href="<?= url_to('userDeleteHazard', $data->id); ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin ingin menghapus data User ?')">Delete</a>
